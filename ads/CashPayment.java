...
public class CashPayment extends javax.swing.JFrame {
    public String fname,email,bookedseats,movie,time;
    int seatcount;
    int amount;
    String s1;
    /**
     ...
     */
    public CashPayment(String fname1,String email1,String movie1,String time1,String bookedseats1,int seatcount1) {
        initComponents();
        fname=fname1;
        email=email1;
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("DejaVu Serif Condensed", 3, 20)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 255, 255));
        jLabel1.setText("   Your Seat has been Blocked !!");

        jLabel2.setText("NOTE :- Please reach 15mins before in order to pay the amount ");

        jLabel3.setBackground(new java.awt.Color(0, 0, 0));
        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 255, 255));
        jLabel3.setText("Payble Amount is:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        HomeScreen hs = new HomeScreen(fname,email);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //Mail sending to user:
                                              ...
                                              String[] to = {email}; // list of recipient email addresses
                                                ...
                                                String body = "Your tickets have been booked.\n Movie : "+movie+"\n Time : "+time+" \n They are:"+bookedseats+".Pay "+s1+" at counter to get your tickets.";
...
private static void sendFromGMail(String from, String pass, String[] to, String subject, String body) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashPayment("\0","\0","\0","\0","\0",0).setVisible(true);
            }
        });
    }
